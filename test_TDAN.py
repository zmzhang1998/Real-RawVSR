...
parser.add_argument('--model', type=str, default='model_TDAN', help='base model')
...
from models_TDAN.model_TDAN import TDAN_VSR
import utils
...
for test_data in tqdm(test_dataloader):
    ...
    with torch.no_grad():
        ...
        # Save image
        if opt.save_image:
            utils.save_RGB(HR_RGB_cor, str(opt.scale), test_data['RGB_gt_name'], 'TDAN')
